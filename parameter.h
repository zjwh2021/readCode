...
#define MAXPI   		200000   /* numebr of primary inputs */
#define MAXPO   		200000    /* number of primary outputs */
#define MAXFAULT		4000000   /* number of faults */
#define MAXFIN  		1500 	 /* number of fanin lines */
#define	MAXFOUT		500000	/* maximum number of fanout lines */

#define MAXSTRING   	2048	 /* maximum size of a string */
#define HASHSIZE		3999999   /* symbol table size, prime */
...
/* For ATALANTA only */
#define	MAXBUF		50000	/* number of buffers for backtrace */
#define	MAXOBJ		100000
#define	MAXTREE		40000
#define	MAXTEST		300000
#define SHUFFLES	30
#define TWO		2
#define STOP		-1	
